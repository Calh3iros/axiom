...
export default function PanicModePage() {
  ...
  const tabs = [
    { key: 'summary' as const, label: 'Summary', icon: BookOpen, desc: '1-page key concepts' },
    { key: 'questions' as const, label: 'Exam Q&A', icon: HelpCircle, desc: '10 likely questions' },
    { key: 'flashcards' as const, label: 'Flashcards', icon: Lightbulb, desc: 'Quick memorization' },
    { key: 'plan' as const, label: 'Study Plan', icon: Clock, desc: '2-hour guided plan' },
  ];
        ...
        <div className="relative max-w-4xl mx-auto px-4 pt-8 pb-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--color-text-secondary)] text-lg max-w-lg mx-auto">
              Exam tomorrow? Enter your subject and get a complete study package in seconds.
            </p>
          </div>
              ...
              <div className="relative flex items-center justify-center gap-3 py-4 text-white font-extrabold text-base tracking-wide disabled:opacity-40">
                {loading ? (
                  <>
                    ...
                    <span>Generating your study package...</span>
                  </>
                ) : (
                  <>
                    <AlertTriangle className="w-5 h-5" />
                    <span>⚡ GENERATE EXAM PREP PACKAGE</span>
                  </>
                )}
              </div>
            </button>
