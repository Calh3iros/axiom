    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg0)] px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link
            href="/"
            className="font-mono text-4xl font-bold tracking-tight text-[var(--color-text-primary)] inline-block"
          >
        ...
        <div className="bg-[var(--color-bg1)] border border-[var(--color-border)] rounded-2xl p-8 shadow-xl shadow-black/20">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-xs text-[var(--color-ax-blue)] hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[var(--color-ax-blue)] hover:bg-orange-500 text-white font-semibold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
        ...
        <p className="text-center text-sm text-[var(--color-text-secondary)] mt-6">
          ...
          <Link
            href="/auth/signup"
            className="text-[var(--color-ax-blue)] hover:underline font-medium"
          >
            Sign up
          </Link>
        </p>
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-[var(--color-bg0)] flex items-center justify-center">
