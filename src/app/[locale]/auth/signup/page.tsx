      ...
      <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg0)] px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-[var(--color-bg1)] border border-[var(--color-border)] rounded-2xl p-8 shadow-xl shadow-black/20">
            ...
            <Link href="/auth/login" className="inline-block mt-6 text-[var(--color-ax-blue)] hover:underline text-sm font-medium">
              Back to login
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg0)] px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="text-center text-sm text-[var(--color-text-secondary)] mt-6">
          ...
          <Link href="/auth/login" className="text-[var(--color-ax-blue)] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
