  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg0)] text-[var(--color-text-primary)]">
      ...
      <nav className="fixed top-0 right-0 left-0 z-50 flex h-16 items-center justify-between border-b border-[var(--color-border)] bg-[var(--color-bg0)]/80 px-6 backdrop-blur-xl md:px-10">
        ...
        >
          AXIOM
          <span className="h-2 w-2 rounded-full bg-orange-400 shadow-[0_0_8px_rgba(249,115,22,0.4)]" />
        </Link>
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/solve"
            className="rounded-lg bg-orange-500 px-4 py-2 text-sm font-semibold text-[var(--color-bg0)] transition-all hover:bg-orange-400 hover:shadow-[0_0_20px_rgba(249,115,22,0.3)]"
          >
